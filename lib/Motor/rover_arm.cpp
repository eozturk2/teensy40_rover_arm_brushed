...
void commandCallback(const std_msgs::Float32MultiArray &command)
{
    ...
    feedback_buffer[0] = (float)Elbow.currentAngle;
    feedback_buffer[1] = (float)Shoulder.currentAngle;
    feedback_buffer[2] = (float)Waist.currentAngle;
    feedback.data = feedback_buffer;
    interrupts();
    ...
    noInterrupts();
    feedback.data_length = 3;
    feedback_buffer[0] = (float)End_Effector.currentAngle;
    feedback_buffer[1] = (float)Wrist_Roll.currentAngle;
    feedback_buffer[2] = (float)Wrist_Pitch.currentAngle;
    feedback.data = feedback_buffer;
    interrupts();
#endif
